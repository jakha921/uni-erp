...
- [ ] Реализовать 3-step flow: ввод телефона → SMS код → новый пароль (Stepper компонент)
- [ ] Таймер повторной отправки SMS (60 сек countdown)
...
- [ ] Drill-down: клик по факультету → фильтр контрактов
